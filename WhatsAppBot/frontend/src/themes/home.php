...
<head>
    ...
    <link rel="stylesheet" href="src/assets/css/new.css" />
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex align-items-end row">
                                <div class="col-sm-7">
                                    <div class="card-body">
                                        <h5 class="card-title text-primary"> Bem Vindo ao WhatsApp - [BOT]</h5>
                                        <p class="mb-4">
                                        <p>O <strong>WhatsApp - [BOT]</strong> foi desenvolvido <strong>emcima da WhatsApp-Api OpenSource</strong> que utiliza a biblioteca <strong>WhatsAppWeb.js</strong> e visando sempre ajudar a comunidade, o projeto é <strong>OpenSource</strong>, você é livre para modificar e usar como quiser, tentaremos mantê-lo sempre atualizado e funcional.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
