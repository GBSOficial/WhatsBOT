...
if (isset($_POST['submit'])) {
    ...
    if (is_uploaded_file($_FILES['file']['tmp_name'])) {
        ...
        if ($handle !== FALSE) {
            ...
            $instancia = '/client/sendMessage/' . $instancia_nome;
            ...
            // Recebendo o texto da mensagem e tempo de delay via post
            ...
            echo "window.location='?page=send-message';</script>";
                                    ...
                                    <div class="card-body">
                                        <div class="center">
                                            <div class="mb-3">
                                                ...
                                                <select id="defaultSelect" class="form-select" name="instancia">
