...
if (isset($_POST['cadastrar_config'])) {
    ...
    try {
        ...
        if ($count > 0) {
            ...
            if ($stmt->rowCount() > 0) {
                echo "<script>alert('Dados cadastrados com sucesso!'); window.location.href = '?page=config-api';</script>";
            } else {
                echo "<script>alert('Ocorreu um erro ao cadastrar os dados.'); window.location.href = '?page=config-api';</script>";
            }
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
...
if (isset($_POST['limpar_config'])) {
    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            echo "<script>alert('Dados limpos com sucesso!'); window.location.href = '?page=config-api';</script>";
        } else {
            echo "<script>alert('Ocorreu um erro ao limpar os dados.'); window.location.href = '?page=config-api';</script>";
        }
    } catch (PDOException $e) {
        echo 'Error: ' . $e->getMessage();
    }
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Configurações /</span> WhatsApp API</h4>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <!-- Account -->
